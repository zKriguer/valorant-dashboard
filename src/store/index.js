    ...
    actions: {
        ...
        setMatches(store) {
            ...
            store.state.partidas.forEach((partida, index) => {
                ...
                data.textContent = format(new Date(partida.metadata.game_start * 1000), '{rel}')
                ...
                if ((modo == "competitive" || modo == "unrated") && (jogadorVenceu == false)) {
                    result.textContent = "LOSS";
                } else if ((modo == "competitive" || modo == "unrated") && (jogadorVenceu == true)) {
        ...
        desc(store, { partida, matchData, modo }) {
            ...
            matchData.innerHTML = `
              ...
              <div class="data">
                <div class='info mobile'> ${store.state.svgs.clock} <p>Time: ${format(new Date(partida.metadata.game_start * 1000), '{rel}')
                } </p>  </div>
